                ...
                <div>
                  ...
                  <div className="mt-2.5">
                    <input
                      ...
                      className="block w-full rounded-md border-0 bg-zinc-800 px-3.5 py-2 text-white shadow-sm ring-1 ring-inset ring-zinc-50/5 focus:ring-2 focus:ring-inset focus:ring-primary-500 sm:text-sm sm:leading-6"
                    />
                  </div>
                </div>
                <div>
